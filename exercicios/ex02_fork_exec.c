...
int main(void)
{
    ...
    for (int i = 0; i < 2; i++) {
        ...
        if (pid == 0) {
            if (i == 0) {
                // TODO: 1o filho: execl("./alo", "alo", (char *)NULL);
                //       Lembre: argv[0] ("alo") tambem entra na lista, e ela termina em NULL.
                // >>> escreva seu codigo aqui <<<
            } else {
                // TODO: 2o filho: monte char *args[] = {"echo", "alo", "do", "echo", NULL}
                //       e chame execvp("echo", args)  (o 'p' procura o programa no PATH).
                // >>> escreva seu codigo aqui <<<
            }
